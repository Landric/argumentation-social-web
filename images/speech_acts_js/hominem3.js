var r = Raphael("hominem3", 800, 600);
...
var x = left + (5 * x_seperation), y = y_top + (10 * y_seperation);
...
var x = left + (5 * x_seperation), y = y_top + (2 * y_seperation);
var P_Node_1 = r.ellipse(x, y, 20, 20).attr({fill: "#a1a", stroke: "#a1a", "fill-opacity": 0.2, "stroke-width": 2, cursor: "pointer"}).drag(move, dragger, up);
var P_Node_1_text = r.text(x, y, "P").attr({cursor: "pointer"}).drag(move, dragger, up);
illocutions["P_Node_1"] = P_Node_1;
P_Node_1.pair = P_Node_1_text;
P_Node_1_text.pair = P_Node_1;


connections.push(r.connection(illocutions['I_Node_3_C1'], illocutions['CA_Node_1'], "#333"));
connections.push(r.connection(illocutions['CA_Node_1'], illocutions['P_Node_1'], "#333"));
connections.push(r.connection(illocutions['U_Node_1'], illocutions['P_Node_1'], "#333"));
